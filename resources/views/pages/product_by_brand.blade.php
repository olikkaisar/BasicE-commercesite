...
@section('content')
				<h2 class="title text-center">Features Items</h2>
						<?php 
							    foreach ($product_by_brand as $v_product_by_brand) { ?>
					<div class="col-sm-4">
						<div class="product-image-wrapper">
							<div class="single-products">
									<div class="productinfo text-center">
										<img src="{{URL::to($v_product_by_brand->product_image)}}" style="height: 230px" alt="" />
										<h2>{{$v_product_by_brand->product_price}} TK</h2>
							...
							<div class="choose">
								<ul class="nav nav-pills nav-justified">
									<li><a href="#"><i class="fa fa-plus-square"></i>{{$v_product_by_brand->brand_name}}</a></li>
